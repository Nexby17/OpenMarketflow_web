...
def _load_lab_env():
    env_path = _os.path.join(_HERE, ".env")
...
parser.add_argument("--paper", action="store_true", default=True)  # PAPER LAB: всегда paper
...
def load_params() -> OFParams:
    ...
    cfg_path = os.path.join(_HERE, "of_config_paper_mx.json")  # PAPER LAB
...
# --- State persistence ---
STATE_FILE = os.path.join(_HERE, "state", "of_state_paper_mx.json")  # PAPER LAB: изолированный state
